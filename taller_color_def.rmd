---
title: "talleR peRcepcion del coloR VI joRnadas R-hispano"
author: "pedro.concejerocerezo at telefonica.com"
date: "Viernes 24 de octubre, 2014"
...
- A los organizadores de estas nuestras (maravillosas) Jornadas de Usuarios R
...
- A José Antonio Cañadas (<https://twitter.com/joscani>) por sus mapas (<http://rpubs.com/joscani/mapa_paro_andalucia>)
...
Este documento es la documentación para el talleR de coloR dentro de las jornadas R-hispano 2014:
...
setwd("C:/Users/pedroc/Desktop/repos-git-2014/taller-color")
...
El color es una propiedad física de la luz emitida o reflejada por los objetos. Pero es esencial saber que el color que nosotros percibimos es una construcción de nuestro sistema cognitivo.
...
En suma: en la percepción de color tanto retina como córtex están involucrados, y gobernados por principios generales como la "constancia del color":
...
Un poco horrible no? Es lo que sucede siguiendo las recomendaciones al pie de la letra. O quizás por no haber hecho la recomendación adecuadamente. Veamos otra formulación:
