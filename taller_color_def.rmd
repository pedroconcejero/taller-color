...
HSV usa valores 0-1 como RGB por defecto a no ser que especifiquemos maxColorValue = 255.
...
<http://cran.r-project.org/web/packages/colorspace/vignettes/hcl-colors.pdf> (Paquete colorspace)
...
colortools::PALETAS CUALITATIVAS
...
colortools::PALETAS SECUENCIALES
...
colortools::PALETAS DIVERGENTES
...
colortools::choose_palette() UNA INTERFAZ GRÁFICA PARA ELEGIR PALETA
...
barplot(t, col=palette(rainbow(32)),   
        legend = rownames(t),
        horiz = T)
